...
Aby sprawdzić czy linia spełnia wymagania z inputu wykorzystuję funkcję if_one_block(), która zwraca
True jeżeli w linii jest spójny czarny blok o długości jaka powinna być (z inputu info)
'''
import random
import math
...
# Funkcja generująca obrazek początkowy (same 0)
