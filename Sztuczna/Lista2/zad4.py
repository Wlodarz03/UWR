...
def main():
    ...
    # stopien = 1.1 20 sekund szybciej - wszystkie testy przechodza
    # stopien = 1.2 40 sekund szybciej - 6 testow nie przechodzi
    # stopien = 20 bardzo szybko rozwiązuje, ale praktycznie nic nie jest optymalne
    stopien_n = 1.125
