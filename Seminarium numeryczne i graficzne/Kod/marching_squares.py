...
def corner(x,y,srodki,promienie):
...
mids = [[30,5],[25,55],[5,10],[55,30],[30,30]]
promienie = [5,6,2,4,3]
counters = [[1,-1],[1,1],[1,0],[-1,-1],[0,1]]
...
while running:
    ...
    for i in range(height):
        for j in range(width):
            field[i][j] = corner(i, j, mids,promienie)
